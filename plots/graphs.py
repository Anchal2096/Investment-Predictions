...
csv_obj = pd.read_csv("F:/Pycharm/Investment-Predictions/Datasets/Investment_Prediction_classified_data1.csv")
original_csv = pd.read_csv("F:/Pycharm/Investment-Predictions/Datasets/Investment_Prediction(csv).csv")
...
count_of_each_age_group_target_class_0 = {"18-19": 0, "20-29": 0, "30-39": 0, "40-49": 0, "50-59": 0, "60-69": 0,
                                          "70-79": 0, "Prefer not to say": 0}
count_of_each_age_group_target_class_1 = {"18-19": 0, "20-29": 0, "30-39": 0, "40-49": 0, "50-59": 0, "60-69": 0,
                                          "70-79": 0, "Prefer not to say": 0}
...
people_in_different_age_group = {"18-19": 0, "20-29": 0, "30-39": 0, "40-49": 0, "50-59": 0, "60-69": 0, "70-79": 0,
                                 "Prefer not to say": 0}
...
plt.savefig("bargraph.png", dpi=500)
plt.show()
