...
predicted_outcome = adding_target_to_munged_csv_file(munged_df, "F:/Pycharm/Investment-Predictions/Datasets"
                                                                "/Investment_Prediction_classified_data1.csv",
                                                     count_of_answers_by_person)

classifier_and_prediction("F:/Pycharm/Investment-Predictions/Datasets/Investment_Prediction_classified_data1.csv")
